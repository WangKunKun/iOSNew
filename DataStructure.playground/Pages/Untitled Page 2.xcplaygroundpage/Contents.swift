...
//MARK: 取出数组中三数之和等于target的 所有不重复组合 双指针
...
func letterCombinations(_ digits: String) -> [String] {
    var dict:[Character:String] = ["2":"abc","3":"def","4":"ghi","5":"jkl","6":"mno","7":"pqrc","8":"tuv","9":"wxyz"]
    var list:[String] = []
    ...
    for index in str.indices {
        ...
        for i in 1..<list.count {
            for thisIndex in list[i].indices {
                let thisChar = list[i][thisIndex]
                //生成string
            }
        }
    }
